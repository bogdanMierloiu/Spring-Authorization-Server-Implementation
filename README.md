...
Overview
The Spring Authorization Server project introduces a new technology for managing user authentication and authorization within Spring applications. This server provides a user-friendly web interface where users can create accounts using their name, email address, and other details. Upon registration, users receive an activation code via email to verify their accounts. Once logged in, users can manage their accounts, change passwords, and perform other account-related actions.
...
Account Management: Logged-in users can manage their accounts, including changing passwords.
...
Use the OAuth 2.0 flow to authorize client applications and obtain access tokens.
